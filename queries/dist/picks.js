...
var addPicks = function (picks, groupid) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = process.env.NEXT_PUBLIC_API_URL + "/picks/" + groupid;
...
exports.useAddPicks = function (groupid) {
    return react_query_1.useMutation({
        mutationFn: function (picks) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, addPicks(picks, groupid)];
                    case 1:
                        _a.sent();
                        // Assuming the API returns the newly created picks
                        //const newPicks: FetchedChoice[] = await getPicks(groupid);
                        return [2 /*return*/, picks];
                }
            });
        }); },
        onSuccess: function (newPicks) {
            // get old picks
            var oldPicks = queryclient_1["default"].getQueryData([
                'picks',
                groupid,
            ]);
            if (!oldPicks) {
            ...
            // update the cache
            var picksNow = __spreadArrays(oldPicks, newPicks);
            queryclient_1["default"].setQueryData(['picks', groupid], picksNow);
        }
    });
};
var getPicks = function (group_id) { return __awaiter(void 0, void 0, Promise, function () {
    var url, res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = process.env.NEXT_PUBLIC_API_URL + "/picks/" + group_id;
                return [4 /*yield*/, fetch(url)];
            case 1:
                res = _a.sent();
                if (!res.ok) {
...
exports.useGetPicks = function (groupid) {
    return react_query_1.useQuery({
        queryKey: ['picks', groupid],
        queryFn: function () { return getPicks(groupid); }
    });
};
/**
 *
